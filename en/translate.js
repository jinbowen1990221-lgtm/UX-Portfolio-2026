...
(function () {
  ...
  const PHRASES = {
    ...
    '关于我': 'ABOUT ME',
    '靳博文 · 13 年用户体验 / 产品设计经验。': 'Jin Bowen · 13 years of UX and product design experience.',
    '电话 15618969646 · 邮箱 249197662@qq.com': 'Phone 15618969646 · Email 249197662@qq.com',
    '① 拥有「创始人」视角的商业设计师': '① A commercial designer with a founder’s perspective',
    '13 年全链路设计经验，具备从 0 到 1 独立孵化 SaaS + 交易平台并跑通盈利闭环的实战能力，擅长商业化设计落地，从 ROI、商业模式、获客成本维度制定设计策略。近期主导 AI 标书 SaaS 产品的商业化设计，独立规划按量计费（Token）模式与增值服务增长路径，持续强化「设计驱动商业」的核心能力。': 'Over 13 years of end-to-end design work, I have independently incubated SaaS and transaction platforms from 0 to 1 and helped establish viable revenue loops. I turn commercial goals into design strategy across ROI, business models, and acquisition cost. Most recently, I led the commercialization design of an AI bidding SaaS product, defining token-based usage pricing and value-added growth paths to strengthen a design-led approach to business.',
    '② B/C 端双核驱动': '② Dual strength across B2B and B2C',
    '拥有稀缺的「SaaS 复杂逻辑 + C 端增长裂变」双重架构能力。曾主导出海教育产品「沉浸式游戏化体验」的战略级重构（Jiligaga），也曾搭建多行业通用的 SaaS 装修组件库（微盟）。同时具备 AI 产品落地设计经验，完成 AI 标书智能生成与审查平台的产品定义、核心工作台设计及 RAG 知识库增强、AI 改写降重等能力的完整方案落地。': 'I combine complex SaaS systems thinking with consumer growth design. I led the strategic redesign of Jiligaga into an immersive, game-based learning experience and built a reusable multi-industry SaaS storefront component library at Weimob. I also defined and designed an AI bid-generation and review platform, including its core workspace, RAG-enhanced knowledge base, AI rewriting, and similarity-reduction capabilities.',
    '③ 数据驱动增长': '③ Data-driven growth',
    '拒绝主观臆断，习惯用数据说话。通过本地化视觉策略与漏斗优化，成功将获客转化率提升 131%，协助业务达成 ROI > 1.2 的目标。': 'I replace subjective assumptions with evidence. A localized visual strategy and funnel optimization increased acquisition conversion by 131% and helped the business achieve an ROI above 1.2.',
    '上海屹道晟辉信息服务有限公司 · 产品设计负责人': 'Shanghai Yidao Shenghui Information Services · Product Design Lead',
    '2024.02 — 至今': 'Feb 2024 — Present',
    '小市集 go（数字化市集报名平台）': 'Little Market go (digital market application platform)',
    '：针对「报名流程复杂、押金风险高、私域营销弱」三大痛点，搭建主办方 + 摊主双端架构，覆盖活动发布、在线报名、资金担保、UGC 社区等核心模块；验证「C 端会员订阅 + B 端招商服务费 + 课程」多元盈利模型。': ': Addressed complex applications, deposit risk, and weak private-channel marketing through a two-sided organizer/vendor architecture covering event publishing, online applications, payment protection, and a UGC community. The product tested a diversified model combining consumer subscriptions, organizer service fees, and courses.',
    '领标 AI（AI 标书智能生成与审查平台）': 'LeadBid AI (AI bid-generation and review platform)',
    '：切入招投标行业人均 3-5 天、查重合规风险高的痛点，主导产品定位、用户旅程与核心工作台设计，搭建「上传 → AI 解析 → 参数配置 → 大纲确认 → 正文生成 → 审查降重 → 知识库沉淀」7 步完整闭环；规划 RAG 知识库增强、查重审查、AI 改写降重等核心 AI 能力，设计按量计费（Token）的商业模式。': ': Targeted the three-to-five-day bid-writing cycle and high compliance risk. I led positioning, the user journey, and the core workspace, creating a seven-step flow from upload and AI parsing through configuration, outline approval, drafting, review, rewriting, and knowledge capture. I also planned the RAG knowledge base, similarity review, AI rewriting, and token-based business model.',
    '业绩': 'OUTCOMES',
    '：小市集 go 上海试点上线首月取得 37.34% 支付转化率、19.77% 会员复购率，形成早期付费验证；领标 AI 完成从 0 到 1 的产品定义与核心方案，形成覆盖 6 大模块的完整产品交付方案。': ': Little Market go recorded 37.34% payment conversion and 19.77% member repeat purchase in its first Shanghai pilot month, providing early willingness-to-pay evidence. LeadBid AI progressed from 0 to 1 with a complete product definition and delivery plan covering six core modules.',
    '叽里呱啦文化传播（上海）有限公司 · 资深产品设计师': 'Jiligaga Culture Communication (Shanghai) · Senior Product Designer',
    '作为海外业务（Jiligaga）核心设计负责人，主导产品从 0 到 1 孵化与迭代，推动产品形态从「教育工具」向「沉浸式游戏化体验」转型。': 'As the core designer for Jiligaga’s international business, I led 0-to-1 incubation and iteration, transforming the product from an educational utility into an immersive game-based experience.',
    '产品架构重构': 'Product architecture redesign',
    '：对标 Lingokids、Khan Kids 等竞品与本地用户画像，将课程定位从「在线课程」转为「寓教于乐的数字玩具」，设计横向关卡地图，用「探索旅程」心智驱动孩子的学习动力。': ': Based on Lingokids, Khan Kids, and local user profiles, repositioned the course from an online class to an educational digital toy. A horizontal level map turned learning into a journey of exploration.',
    '商业增长设计': 'Commercial growth design',
    '：视觉本地化与转化闭环 — 重构信息层级、台湾本地化视觉策略、优化「领取 → 加好友 → 付费」漏斗。': ': Reworked information hierarchy and Taiwan-specific visual language, then optimized the claim → add-contact → payment funnel.',
    ...
    '：安卓端领课率暴增 131%、iOS 增长 62%；激活至首页转化率突破 60%、首日完课率提升 30%、D1 留存率提升至 42.7%。': ': Lesson-claim conversion increased 131% on Android and 62% on iOS; activation-to-home conversion exceeded 60%, first-day lesson completion rose 30%, and D1 retention reached 42.7%.',
    '喜马拉雅 · 资深 UX 设计师': 'Himalaya · Senior UX Designer',
    '从 0 到 1 搭建面向企业培训市场的 B 端产品，解决用户场景单一、功能覆盖不足、缺乏独立后台与品牌感知弱的问题。主导用户端（APP/H5）学习路径与管理端（B 端后台）数据看板全链路设计，沉淀 Button States、多选控件、卡片式设计等组件规范。': 'Built a B2B enterprise-training product from 0 to 1, addressing narrow use cases, incomplete functionality, the lack of an independent admin system, and weak brand recognition. I led the learner journey across app and H5 as well as the admin dashboard, and established reusable component standards for button states, multi-select controls, and cards.',
    '：改版后学员体验综合评分 9.42（高于同主题往期均分 8.46）；MVP 验证中完课率 92%、复购/再次参与意愿率 91%。': ': After redesign, the learner experience scored 9.42 versus a previous category average of 8.46. MVP validation recorded 92% course completion and 91% intent to repurchase or participate again.',
    ...
    '：针对装修模板类型单一、风格不统一、C 端转化不理想等痛点，对直播、商品、图文导航等基础组件标准化重构；打造「千人千面」装修体验，设计适配生鲜、家居、美妆等行业的梯度模板，大幅降低商家装修门槛与学习成本。': ': Standardized livestream, product, and visual-navigation components to address limited templates, inconsistent styling, and weak consumer conversion. Personalized storefront options and tiered templates for grocery, home, and beauty merchants substantially reduced setup and learning costs.',
    '星巴克 KA 定制 · 支付裂变设计': 'Starbucks key-account customization · Post-payment referral design',
    '：将分享入口升级为「弹窗 + Banner」强引导，引入「咖啡教室」游戏化概念，结合节日氛围采用精致贴纸化插画风格。': ': Upgraded the sharing entry point with a modal and banner, introduced a gamified Coffee Classroom concept, and used refined sticker-style illustrations for seasonal campaigns.',
    '：星巴克会员支付后分享意愿从 8% 显著提升至 23%，优化「下单 → 分享 → 领福利」闭环路径。': ': Post-payment sharing intent among Starbucks members increased from 8% to 23%, strengthening the order → share → reward loop.',
    ...
    '：基于用户调研（89.1% 用户关注价格）确立「更划算、性价比」心智主张，结构化展示权益、门店详情页强化底部悬浮购买入口，显著提升「浏览 → 领券 → 支付」开卡转化率。': ': Research showed that 89.1% of users cared about price, leading to a clear value-for-money proposition, structured benefit presentation, and a persistent purchase action on store pages. These changes improved browse → claim coupon → pay conversion.',
    'B 端 SaaS · 美收银智能收银重构': 'B2B SaaS · Meishouyin smart POS redesign',
    '：推动产品从「支付工具」向「经营管家」转型，新增自动对账、会员营销及经营报表模块，重新设计 Dashboard 核心指标（今日收入、订单量、流水路径），提升商家高频操作效率。': ': Evolved the product from a payment tool into an operations assistant with automated reconciliation, member marketing, and business reporting. Redesigned dashboard metrics—today’s revenue, order volume, and transaction flow—to improve high-frequency merchant tasks.',
